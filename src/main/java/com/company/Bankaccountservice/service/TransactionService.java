...
import com.company.Bankaccountservice.repository.TransactionRepository;
import com.company.Bankaccountservice.service.mapper.TransactionMapper;
import com.company.Bankaccountservice.service.validate.TransactionValidate;
...
public class TransactionService implements SimpleCrud<Integer, TransactionDto> {
    ...
    public ResponseDto<TransactionDto> getWithAccount(Integer id) {
        return this.transactionRepository.findByTransactionIdAndDeletedAtIsNull(id)
                .map(transaction -> ResponseDto.<TransactionDto>builder()
                        .message("OK")
                        .success(true)
    ...
    public ResponseDto<TransactionDto> getByCustomer(Integer id) {
        return this.transactionRepository.findByCustomerIdAndDeletedAtIsNull(id)
                .map(transaction -> ResponseDto.<TransactionDto>builder()
                        .message("OK")
                        .success(true)
                        .data(this.transactionMapper.toDto(transaction))
